...
<div class="div-block-4">
    <div class="div-block-5"><img src="../assets/cc-logo-small-white.svg" class="splash-logo">
      <h1 class="splash-h1">Enter Invitation Code</h1>
      <div class="splash-content-1">
        <div class="splash-text-50">We're distributing special invitation codes to teachers, schools, and online parent groups. If you received a code, enter it here. If not, don't worry about it! :)</div>
      </div>
      <div class="w-form">
        <form id="email-form" name="email-form" data-name="Email Form"><input type="text" class="splash-text-input w-input" maxlength="256" name="email" data-name="Email" id="email" required=""></form>
      ...
      <div class="splash-text-small-50">You can skip this if you don&#x27;t have a code</div>
    </div>
