...
<div class="body">
  ...
  <div class="top-content-container">
    <div class="page-lead-text">Check children in when parents drop off, and check out when parents pick up. Be sure to send the text so that we can track time and bill the parent.</div><a href="" class="button-small-outline w-button">Learn More</a></div>
