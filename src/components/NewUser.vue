...
<div id="body onb-body-splash">
  <div class="div-block-6"><img width="150" alt=""></div>
  ...
  <div class="embed-facebook-button">
    <div class="w-embed">
      <div class="fb-login-button button" data-max-rows="1" data-size="large" data-button-type="continue_with" data-show-faces="false" data-auto-logout-link="false" data-use-continue-as="false">Continue with Facebook</div>
    </div>
  </div>
</div>
</template>
...
.div-fake-map {
  height: 200px;
  background-image: url('../images/Screenshot-2018-09-18-15.26.16.png');
...
.onb-title-bar {
  ...
  background-image: url('../images/cclogo-house-blue.svg');
