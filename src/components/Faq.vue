...
<div class="body">
  ...
  <div id="Points" class="section">
    <div class="container w-container">
      ...
      <p class="paragraph">That's okay! Points are not required to book childcare; they just help us ensure that over time every parent is doing their part. By committting to offer one playdate every month, you're certain to earn points soon.</p>
  ...
  <div id="Community-Rules" class="section f6f6f6">
    <div class="container w-container">
      ...
      <ul class="unordered-list">
        ...
        <li class="ul-item">Only the host of the event can host. Children should never be left alone, or with anyone who is not the host of the event. The host must remain on the premises at all times during the playdate, and if there is an emergency that require ending the playdate early, you must contact each parent and accommodate their needs for pickup.</li>
