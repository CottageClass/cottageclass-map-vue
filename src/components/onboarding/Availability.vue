 ...
 <div class="onb-content-container">
    ...
    <div class="onb-form-block-checkbox-list w-form">
      <form id="email-form" name="email-form" data-name="Email Form" class="onb-form-checkbox-list">
        <div class="checkbox-field-extra-space" :class="{'active-checkbox': availability.availableMornings}"><input v-model="availability.mornings" type="checkbox" id="checkbox" name="checkbox" data-name="Checkbox" class="onb-checkbox w-checkbox-input" :class="{ 'active-checkbox': availability.mornings }"><label for="checkbox" class="onb-checkbox-label w-form-label">9am - 3pm</label></div>
        <div class="checkbox-field-extra-space" :class="{'active-checkbox': availability.availableAfternoons}"><input v-model="availability.afternoons" type="checkbox" id="checkbox-5" name="checkbox-5" data-name="Checkbox 5" class="onb-checkbox w-checkbox-input"><label for="checkbox-5" class="onb-checkbox-label w-form-label">3pm - 7pm</label></div>
        <div class="checkbox-field-extra-space" :class="{'active-checkbox': availability.evenings}"><input v-model="availability.availableEvenings" type="checkbox" id="checkbox-4" name="checkbox-4" data-name="Checkbox 4" class="onb-checkbox w-checkbox-input"><label for="checkbox-4" class="onb-checkbox-label w-form-label">After 7pm</label></div>
        <div class="checkbox-field-extra-space" :class="{'active-checkbox': availability.weekends}"><input v-model="availability.availableWeekends" type="checkbox" id="checkbox-3" name="checkbox-3" data-name="Checkbox 3" class="onb-checkbox w-checkbox-input"><label for="checkbox-3" class="onb-checkbox-label w-form-label">Weekends</label></div>
      </form>
    </div>
