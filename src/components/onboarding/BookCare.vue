...
<div class="body">
  <div class="content-container">
    ...
    <div class="radio-form-block w-form">
      <form id="email-form" name="email-form" data-name="Email Form" class="radio-form">
        <div class="radio-button-field w-radio"><input type="radio" id="radio" name="radio" value="Radio" data-name="Radio" class="radio-button w-radio-input"><label for="radio" class="radio-button-label w-form-label">[OUR SNAZZY TIME CHOOSER]</label></div>
      </form>
    </div>
    <div class="form-describe-need w-form">
      <form id="email-form-2" name="email-form-2" data-name="Email Form 2">
        <p class="describe-label">Need multiple days?</p><textarea id="field" name="field" placeholder="Describe your need and schedule here." maxlength="5000" class="text-area-decribe-need w-input"></textarea></form>
    </div>
    <div class="promo-container"><img src="@/assets/free.svg" alt="" class="image-free-tag">
      ...
      <div class="counter">
        <div class="counter-item">
          <div id="hour-count" class="count">09</div>
          <div class="label-time-interval">Hours</div>
        </div>
        <div class="counter-item">
          <div id="min-count" class="count">05</div>
          <div class="label-time-interval">Minutes</div>
        </div>
        <div class="counter-item">
          <div id="sec-count" class="count">03</div>
